        ...
        <div className="col-span-1 space-y-6">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <div className="space-y-3">
              <Link
                href={`/products/shipping?product=${params.id}`}
              ...
              >
                <div className="flex items-center">
                  ...
                  <span className="font-medium">Kargolama Bilgisi</span>
                </div>
              </Link>

              <button className="block w-full text-left px-4 py-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                <div className="flex items-center">
                  <svg className="w-5 h-5 mr-3 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                  <span className="font-medium text-gray-700">İade Kaydı Ekle</span>
                </div>
              </button>
              ...
              <button className="block w-full text-left px-4 py-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                <div className="flex items-center">
                  ...
                  <span className="font-medium text-gray-700">Envanter Güncelle</span>
                </div>
              </button>
            </div>
          </div>
